...
void FemPosDeviation::CalculateKernel(
...
void FemPosDeviation::CalculateOffset(std::vector<c_float>* q) {
  for (int i = 0; i < num_of_points_; ++i) {
...
void FemPosDeviation::CalculateAffineConstraint(
...
void FemPosDeviation::SetPrimalWarmStart(
    std::vector<c_float>* primal_warm_start) {
...
bool FemPosDeviation::OptimizeWithOsqp(
